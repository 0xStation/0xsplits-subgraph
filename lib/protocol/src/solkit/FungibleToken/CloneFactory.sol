...
import {ConfigurableFungibleTokenClone} from "./ConfigurableClone.sol";

contract ConfigurableFungibleTokenCloneFactory is ConfigurablePrimitiveCloneFactory {
        ...
        returns (address)
    {
        ...
        ConfigurableFungibleTokenClone(primitive).__ConfigurableFungibleToken_init(
            name,
            symbol,
            _allowedContracts,
            mintPolicy,
